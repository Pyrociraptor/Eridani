...
/obj/item/weapon/gun/energy/protector
	name = "\improper A-98a \'Protector\'"
	desc = "The A-98a is the first firearm custom-designed for Nanotrasen by Ace Energy Consortium. It features a powerful stun mode, and \
	...
	description_fluff = "The first 'commission' from an Ace Energy Consortium liason for NanoTrasen, this gun has a wireless connection to the computer's datacore to ensure it can't be used without authorization from heads of staff who have raised the alert level. Until then, *click*!"
