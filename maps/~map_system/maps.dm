...
/datum/map
	...
	var/datum/spawnpoint/spawnpoint_died = /datum/spawnpoint/tram 	// Used if you end the round dead.
	var/datum/spawnpoint/spawnpoint_left = /datum/spawnpoint/tram 	// Used of you end the round at centcom.
